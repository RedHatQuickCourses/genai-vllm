 ...
 * Function Calling
 * Contract Analysis
 * Tool Calling(Not compatible with Colab)
 * Structured Responses(Not compatible with Colab)

=== Compound Systems
 * RAG - LangChain Open
 * RAG - LlamaIndex Open
 * Understanding ReAct Open
 * Agentic RAG Open
 * Travel planner Agent Open
 * Github Agent Open
...
=== Intrinsic Functions
 * Chain of thought (cot) reasoning Open In Colab
